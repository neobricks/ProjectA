                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-3 ml-auto ">
                                    <div class="nav flex-column">
                                        <a class="nav-link" href="https://store.steampowered.com/app/550650/Black_Squad/"><?= __('Game page') ?></a>
                                        <a class="nav-link" href="https://steamcommunity.com/app/550650/discussions/"><?= __('Steam Discussion') ?></a>
                                        <a class="nav-link" href="https://discordapp.com/invite/blacksquad"><?= __('Discord') ?></a>
                                        <a class="nav-link" href="https://www.facebook.com/playblacksquad/"><?= __('Facebook') ?></a>
                                        <a class="nav-link" href="http://support.blacksquad.com/"><?= __('Help Center') ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
